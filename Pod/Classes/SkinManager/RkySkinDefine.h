...
static NSString *const kSkinConfigKeyColorHighlighted = @"rgb_hl";
static NSString *const kSkinConfigKeyColorDisabled = @"rgb_dis";
static NSString *const kSkinConfigKeyColorSelected = @"rgb_sel";
static NSString *const kSkinConfigKeyColorShadow = @"rgb_shadow";
...
static NSString *const KLixianManageModule=@"LixianManageModule";
static NSString *const KLixianCellColor=@"LixianCellColor";
static NSString *const KLixianCellText=@"LixianCellText";
static NSString *const KLixianBgColor=@"LixianBgColor";
static NSString *const KLixianLineColor=@"LixianLineColor";
static NSString *const KLixianSectionText=@"LixianSectionText";
static NSString *const KLixianSectionColor=@"LixianSectionColor";
